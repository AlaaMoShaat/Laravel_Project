            ...
            <div class="sidebar">
                    ...
                    <div class="image">
                        @if (Auth::guard('admin')->id())
                            @if (auth('admin')->user()->image != '')
                                <img src="{{ asset('storage/images/admin/' . auth('admin')->user()->image) }}"
                                    class="img-circle elevation-2" alt="User Image">
                            @else
                                <img src="{{ asset('storage/images/admin/userSolid.png') }}"
                                    class="img-circle elevation-2" alt="User Image">
                            @endif
                        @elseif(Auth::guard('author')->id())
                            @if (auth('author')->user()->image != '')
                                <img src="{{ asset('storage/images/author/' . auth('author')->user()->image) }}"
                                    class="img-circle elevation-2" alt="User Image">
                            @else
                                <img src="{{ asset('storage/images/author/userSolid.png') }}"
                                    class="img-circle elevation-2" alt="User Image">
                            @endif
                        @endif
                    </div>
                    <div class="info">
                        @if (Auth::guard('admin')->id())
                            <a href="{{ Route('admins.edit', auth('admin')->user()->id) }}"
                                class="d-block">{{ auth('admin')->user()->full_name }}</a>
                        @elseif(Auth::guard('author')->id())
                            <a href="{{ Route('authors.edit', auth('author')->user()->id) }}"
                                class="d-block">{{ auth('author')->user()->full_name }}</a>
                        @else
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            @elseif(Auth::guard('author')->id())
                                <a href="{{ Route('authors.edit', auth('author')->user()->id) }}" class="nav-link">
                                    <i class="fas fa-user-edit nav-icon"></i>
                                    <p>Edit Your Profile</p>
                                </a>
                            @endif
